---
title: Installation
description: Build and run GigaWallet from source or containers
---
...
note that you can easily extend Gigawallet for different databases, see [Extending](/docs/extending).
